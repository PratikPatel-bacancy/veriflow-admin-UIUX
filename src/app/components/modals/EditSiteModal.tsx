...
export default function EditSiteModal({ isOpen, onClose, onSubmit, siteData }: EditSiteModalProps) {
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="flex flex-col">
                ...
                <select
                  ...
                  className="bg-white dark:bg-[#1a2d47] border border-[#d9d9d9] dark:border-[rgba(59,130,246,0.15)] rounded-[2px] px-3 py-2 text-[14px] text-[#111827] dark:text-[#e8eef5] focus:outline-none focus:border-[#1890ff] focus:ring-1 focus:ring-[#1890ff] transition-colors appearance-none bg-[url('data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTAiIGhlaWdodD0iMTEiIGZpbGw9Im5vbmUiIHhtbG5zPSJodHRwOi8vd3d3LnczLm9yZy8yMDAwL3N2ZyI+PHBhdGggZD0iTTUgN2wzIDMgMy0zSDV6bTAtNEw4IDAgMiAzaDZ6IiBmaWxsPSIjMDAwIiBmaWxsLW9wYWNpdHk9Ii44NSIvPjwvc3ZnPg==')] bg-[right_12px_center] bg-no-repeat"
                >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col">
                ...
                >
                  ...
                  <option value="downtown">Downtown Parking LLC</option>
                  <option value="citycenter">City Center Management</option>
                  <option value="airport">Airport Parking Co</option>
                  <option value="metro">Metro Parking Services</option>
                </select>
              </div>
              <div className="flex flex-col">
                <label className="font-['Inter'] font-normal text-[14px] leading-[22px] text-[rgba(0,0,0,0.85)] dark:text-[#e8eef5] pb-2">
